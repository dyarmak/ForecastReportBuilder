# List of SQL Queries for this report
...
forecastQuery = """SELECT        tbl_SubProject.SubProjectID, tbl_SubProject.ProjectManager, tbl_Client.ClientName, tbl_MasterProject.MasterProjectName, tbl_SubProject.ProjectID, tbl_Projects.ProjectName, tbl_SubProjectType.SubProjectTypeName, 
                         tbl_SubProject.SubProjectType AS SubProjectTypeID, tbl_SubProject.SubProjectName, tbl_SubProject.Forecast, tbl_SubProject.DueDate + 10 AS [Due Date], '' AS Due, tbl_SubProject.SubProjectStatus, tbl_SubProject.Quoted, 
...
invoicedQuery = """SELECT        tbl_InvoiceSummary.SubProjectID, tbl_SubProject.ProjectManager, tbl_InvoiceSummary.InvoiceCompanyName AS ClientName, tbl_MasterProject.MasterProjectName, tbl_Projects.ProjectID, tbl_Projects.ProjectName, 
                         ...
                         tbl_InvoiceSummary.RecognizeRevenueDate AS [Due Date], '' AS Due , tbl_SubProject.SubProjectStatus, tbl_SubProject.Quoted, tbl_SubProject.Forecast AS OriginalForecast, tbl_SubProject.DueDate AS OriginalDueDate, 
                         tbl_SubProject.Budget, tbl_SubProject.ClientBudgetYear, tbl_SubProject.IncludeinBudget, 
                         tbl_InvoiceSummary.InvoiceID, tbl_InvoiceSummary.InvoiceDateSent, tbl_InvoiceSummary.SubTotal
...
creditQuery = """SELECT        tbl_InvoiceSummary.SubProjectID, tbl_SubProject.ProjectManager, tbl_InvoiceSummary.InvoiceCompanyName AS ClientName, tbl_MasterProject.MasterProjectName, tbl_Projects.ProjectID, tbl_Projects.ProjectName, 
                         ...
                         tbl_InvoiceSummary.CreditDateApplied AS [Due Date], '' AS Due ,tbl_SubProject.SubProjectStatus, tbl_SubProject.Quoted, tbl_SubProject.Forecast AS OriginalForecast, tbl_SubProject.DueDate AS OriginalDueDate,
                         tbl_SubProject.Budget, tbl_SubProject.ClientBudgetYear, tbl_SubProject.IncludeinBudget, 
                         '' AS InvoiceID, '' AS InvoiceDateSent, '' AS SubTotal
FROM            tbl_MasterProject INNER JOIN
                         tbl_Projects ON tbl_MasterProject.MasterProjectID = tbl_Projects.MasterProjectID INNER JOIN
                         tbl_InvoiceSummary INNER JOIN
                         tbl_SubProject ON tbl_InvoiceSummary.SubProjectID = tbl_SubProject.SubProjectID ON tbl_Projects.ProjectID = tbl_SubProject.ProjectID INNER JOIN
...
profitCenterQuery = """SELECT        tbl_SubProjectCategories.CategoryDescription AS ProfitCenter, tbl_SubProjectType.SubProjectTypeID
FROM            tbl_SubProjectType INNER JOIN
...
groupsQuery = """SELECT        tbl_SubProjectType.SubProjectTypeID, tbl_SubProjectType.SubProjectTypeName, tbl_SubProjectType.SubProjectCategory, tbl_SubProjectType.SortOrder, tbl_SubProjectType.GroupID, 
                         tbl_SubProjectType_Groups.GroupName
FROM            tbl_SubProjectType INNER JOIN
                         tbl_SubProjectType_Groups ON tbl_SubProjectType.GroupID = tbl_SubProjectType_Groups.GroupID """